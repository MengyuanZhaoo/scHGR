...
def load_data(params):
    ...
    gene_ids = torch.tensor(np.arange(0, num_genes, 1)).to(device)
    ...
    graph.readonly()
    return pre_cells, num_cells, np.array(id2gene), num_genes, num_labels, graph, gene_ids, train_ids, val_ids, test_ids, labels, id2label
